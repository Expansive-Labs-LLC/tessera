...
| FR-010 | The `README.md` SHALL include a "Documentation" section linking to the full documentation site (placeholder URL `https://expansive-labs-llc.github.io/tessera/`) and listing key doc pages: Installation Guide, User Guide, API Reference, Troubleshooting. |
